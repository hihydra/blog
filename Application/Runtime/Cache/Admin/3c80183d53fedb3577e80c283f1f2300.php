...
<table class="table table-striped table-hover">
   ...
   <?php if(is_array($role)): foreach($role as $key=>$vo): ?><tr>
         ...
         <td><?php echo ($vo[status]?开启:关闭); ?></td>
         <td>
         <input type="button" value="配置权限" class="btn btn-default" onclick="edite('<?php echo U('Rbac/access',array('rid'=>$vo['id']));?>')">
         <input type="button" value="编辑角色" class="btn btn-default"  onclick="edite('<?php echo U('Rbac/editRole',array('id'=>$vo['id']));?>')">

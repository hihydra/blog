...
<div class="col-md-12">
<form  id="from"  action="<?php echo U('Category/sortCate');?>" method="post">
<table class="table table-striped table-hover">
   ...
   <?php if(is_array($cate)): foreach($cate as $key=>$vo): ?><tr>
         ...
         <td>
             <input type="text" name="<?php echo ($vo["id"]); ?>" value="<?php echo ($vo["sort"]); ?>" class="btn btn-default">
         </td>
         <td>
         <input type="button" value="添加子分类" class="btn btn-default" onclick="edite('<?php echo U('Category/addCate',array('pid'=>$vo['id']));?>')">
         <input type="button" value="修改" class="btn btn-default" onclick="edite('<?php echo U('Category/editCate',array('id'=>$vo['id']));?>')">
         <input type="button" value="删除" class="btn btn-default"  onclick="del('<?php echo U('Category/delCate',array('id'=>$vo['id']));?>')">

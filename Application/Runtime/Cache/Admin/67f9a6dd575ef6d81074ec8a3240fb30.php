...
<h1 class="page-header">编辑节点</h1>

<div class="col-md-12">
<div id="error" role="alert">
</div>
<form id="from" action="<?php echo U('Rbac/editNode',array('id'=>$node['id']));?>" method="post" class="form-horizontal">
   <div class="form-group">
    <label><?php echo ($type); ?>名称:</label>
    <input type="text" class="form-control" name="name" placeholder="角色名称"  value="<?php echo ($node["name"]); ?>" required>
  </div>
  <div class="form-group">
    <label><?php echo ($type); ?>描述:</label>
    <input type="text" class="form-control" name="title" placeholder="角色描述" value="<?php echo ($node["title"]); ?>" required>
  </div>
  <div class="form-group">
    <label>是否开启:</label>
      <label>

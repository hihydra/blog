...
<h1 class="page-header">修改属性</h1>

<div class="col-md-12">
<form id="from" action="<?php echo U('Attribute/editAttr',array('id'=>$attr['id']));?>" method="post" class="form-horizontal">
  <div class="form-group">
    <label>属性名称</label>
    <input type="text" class="form-control" name="name" placeholder="属性名称" value="<?php echo ($attr["name"]); ?>" required>
  </div>
  <div class="form-group">
    <label>属性颜色</label>
    <input type="text" class="form-control" name="color" placeholder="属性颜色"  value="<?php echo ($attr["color"]); ?>" required>
  </div>
   <div class="form-group">
    <label>属性符号</label>
    <input type="text" class="form-control" name="flag" placeholder="属性符号" value="<?php echo ($attr["flag"]); ?>" required>
  </div>

...
<div class="col-md-12">
   <?php if(is_array($node)): foreach($node as $key=>$app): ?><div class="app">
      ...
      [<a href="<?php echo U('Rbac/delNode',array('id'=>$app['id']));?>">删除</a>]
      </li>          
        <div class="action">
        <?php if(is_array($app["child"])): foreach($app["child"] as $key=>$action): ?><li class="list-group-item list-group-item-info col-md-offset-1">          
                 <b>&nbsp;<?php echo ($action["title"]); ?></b>
                  ...
                  [<a href="<?php echo U('Rbac/delNode',array('id'=>$action['id']));?>">删除</a>]
              ...
              <div class="method">
                   <li class="list-group-item col-md-offset-1">
                      <?php if(is_array($action["child"])): foreach($action["child"] as $key=>$method): ?>&nbsp;<?php echo ($method["title"]); ?>
                        [<a href="<?php echo U('Rbac/editNode',array('id'=>$method['id']));?>">修改</a>]
                        [<a href="<?php echo U('Rbac/delNode',array('id'=>$method['id']));?>">删除</a>]&nbsp;&nbsp;<?php endforeach; endif; ?>
                   </li>                  

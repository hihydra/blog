...
<form id="from" action="<?php echo U('Category/editCate',array('id'=>$cate['id']));?>" method="post" class="form-horizontal">
  <div class="form-group">
    <label>分类名称</label>
    <input type="text" class="form-control" name="name" placeholder="分类名称" value="<?php echo ($cate["name"]); ?>" required>
  </div>
  <div class="form-group">
    <label>别名</label>
    <input type="text" class="form-control" name="slug" placeholder="别名" value="<?php echo ($cate["slug"]); ?>" required>
  </div>
  <div class="form-group">
    <label>分类排序</label>
    <input type="text" class="form-control" name="sort" value="<?php echo ($cate["sort"]); ?>" required>
  </div>

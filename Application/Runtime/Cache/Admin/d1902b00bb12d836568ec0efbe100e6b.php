...
<?php if(is_array($latestarc)): foreach($latestarc as $key=>$vo): ?><a href="<?php echo U('Article/editArticle',array('id'=>$vo['id']));?>" class="list-group-item"><span class="badge pull-right"><?php echo ($vo["click"]); ?></span><?php echo ($vo["title"]); ?></a><?php endforeach; endif; ?>
</div>
</div>
</div>
...
<tbody>
<?php if(is_array($onuser)): foreach($onuser as $key=>$vo): ?><tr>
<td><?php echo ($vo["id"]); ?></td>
<td><?php echo ($vo["username"]); ?></td>
<td><?php echo (date("y-m-d h:m:s",$vo["logintime"])); ?></td>
<td><?php echo ($vo["loginip"]); ?></td>
</tr><?php endforeach; endif; ?>
</tbody>
</table>
<p><a class="btn btn-primary" href="<?php echo U('User/index');?>" role="button">查看详细&raquo;</a></p>
</div>
</div>
</div>
<div class="col-md-6">
...
<span class="badge pull-right"><?php echo ($countarc); ?></span>
文章数量
</li>
<li class="alert alert-info">
<span class="badge pull-right"><?php echo ($countuser); ?></span>
用户数量
</li>
</ul>
</div>

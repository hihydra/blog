...
function fleshVerify(){ 
    ...
    var time = new Date().getTime();
        document.getElementById('verifyImg').src= '{:U("Login/verify")}/login/code/'+time;
}
</script>
</head>
...
<body>
    <div class="container">
      ...
      <form id="from" action="{:U("Login/Register")}" method="post" class="form-signin">
        ...
        <div><img id="verifyImg" src="{:U("Login/verify")}" onclick="fleshVerify()"></div><br>
        <div id="error" role="alert">
		</div>
        <button class="btn btn-lg btn-primary btn-block" type="button" onclick="login()">注册</button>
        <a href="{:U("Login/index")}" class="btn btn-primary btn-lg btn-block" role="button">返回登录</a>
      </form>
